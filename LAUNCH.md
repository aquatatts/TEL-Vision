...
- **Homepage meta description and social sharing image.** Online Store → Preferences. The shop description is empty, so Google and Meta currently get nothing for the homepage. Suggested description: "The Ritual Duo: a sealed two-step tattoo aftercare set built in a working Surfers Paradise studio. Restore Balm for fresh ink, Recovery Cream for the years after. Free shipping Australia-wide." Sharing image: the sealed set hero (tel-ritual-duo-01-sealed-set-hero-clean-v2.jpg).
